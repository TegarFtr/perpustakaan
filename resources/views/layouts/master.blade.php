        ...
        <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="card">
                  ...
                  <div class="card-footer text-center">
                    <a href="{{ asset('AdminLTE') }}/javascript:">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
          ...
          <div class="col-md-4">
            ...
            <div class="card">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="{{ asset('AdminLTE') }}/javascript:void(0)" class="product-title">Samsung TV
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="{{ asset('AdminLTE') }}/javascript:void(0)" class="product-title">Bicycle
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="{{ asset('AdminLTE') }}/javascript:void(0)" class="product-title">
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="{{ asset('AdminLTE') }}/javascript:void(0)" class="product-title">PlayStation 4
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="{{ asset('AdminLTE') }}/javascript:void(0)" class="uppercase">View All Products</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
